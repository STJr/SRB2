...
#endif
			realpatch = (patch_t *)Picture_PNGConvert(pdata, format, NULL, NULL, NULL, NULL, lumplength, NULL, 0);
		}
		else
#endif
#ifdef WALLFLATS
...
#endif
		patch = (patch_t *)Picture_PNGConvert((const UINT8 *)patch, grPatch->picfmt, NULL, NULL, NULL, NULL, len, NULL, 0);
	}
#endif
