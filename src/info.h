...
typedef enum sprite
{
	...
	SPR_BUBB, // Respawn Bubbles

	SPR_SBCH, // Small Blue Mace Chain
	SPR_BBCH, // Big Blue Mace Chain

	SPR_MHEL, // Small Health bar above players
	...
	// Top Down bosses
	SPR_PINE, // Egg Pinball

	SPR_REDI, // Red Eye

	SPR_CHIL, // Chill Penguin
	SPR_CIRN, // Just kidding!
	...
	SPR_GFLO, // Giant flowers (Checker Mountain)
