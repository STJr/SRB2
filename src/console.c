...
#define colset(map, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) \
	...
	// decent but i made most of the colors better thanks for th help :3

	//                      0x1       0x3                           0x9                           0xF
	colset(magentamap, 176, 176, 177, 177, 178, 178, 179, 179, 180, 180, 181, 181, 182, 182, 183, 183);
	colset(yellowmap,   82,  82,  72,  73,  74,  74,  64,  64,  65,  65,  65,  66,  66,  66,  67,  67);
	colset(lgreenmap,   96,  96,  97,  97,  98,  98,  99,  99, 100, 100, 101, 101, 102, 102, 103, 103);
	colset(bluemap,    144, 144, 145, 145, 146, 146, 146, 147, 147, 147, 148, 148, 148, 149, 149, 149);
	colset(redmap,     210, 210, 210,  32,  32,  32,  33,  33,  33,  34,  34,  34,  35,  35,  35,  35);
	...
	colset(skymap,     128, 128, 129, 129, 130, 130, 131, 131, 132, 132, 133, 133, 134, 134, 135, 135);
	colset(purplemap,  144, 144, 160, 160, 160, 161, 161, 161, 162, 162, 162, 162, 163, 163, 163, 163);
	colset(aquamap,    128, 128, 120, 120, 121, 121, 122, 122, 123, 123, 124, 124, 124, 125, 125, 125);
	colset(peridotmap,  72,  72, 188, 188, 188, 189, 189, 189, 189, 190, 190, 191, 191, 104, 104, 104);
	colset(azuremap,   144, 144, 145, 145, 146, 146, 146, 147, 147, 147, 170, 170, 170, 171, 171, 171);
	colset(brownmap,   218, 219, 220, 221, 221, 222, 223, 223, 224, 224, 225, 226, 227, 228, 229, 230);
	colset(rosymap,    200, 200, 201, 201, 201, 202, 202, 203, 203, 203, 204, 204, 204, 205, 205, 205);
