...
#define colset(map, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) \
	...
	colset(purplemap,  144, 144, 160, 160, 161, 161, 161, 162, 162, 162, 163, 163, 163, 164, 164, 164);
	colset(aquamap,    120, 120, 121, 121, 122, 122, 122, 123, 123, 123, 124, 124, 124, 125, 125, 125);
	colset(peridotmap,  72,  72, 188, 188, 189, 189, 189, 190, 190, 190, 191, 191, 191, 104, 104, 104);
	...
	colset(rosymap,    200, 200, 201, 201, 202, 202, 202, 203, 203, 203, 204, 204, 204, 205, 205, 205);
