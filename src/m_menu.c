...
static menuitem_t OP_CameraOptionsMenu[] =
{
	...
	{IT_STRING  | IT_CVAR, NULL, "Pivot Still Player to Camera", &cv_pivot[0], 26},
	...
	{IT_HEADER,            NULL, "Display Options", NULL, 65},
	{IT_STRING  | IT_CVAR, NULL, "Crosshair", &cv_crosshair, 71},
};
...
static menuitem_t OP_Camera2OptionsMenu[] =
{
	...
	{IT_STRING  | IT_CVAR, NULL, "Pivot Still Player to Camera", &cv_pivot[1], 26},

	{IT_HEADER,                                NULL, "Camera Positioning", NULL, 35},
	{IT_STRING  | IT_CVAR | IT_CV_INTEGERSTEP, NULL, "Camera Distance", &cv_cam_savedist[0][1], 41},
	{IT_STRING  | IT_CVAR | IT_CV_INTEGERSTEP, NULL, "Camera Height", &cv_cam_saveheight[0][1], 46},
	{IT_STRING  | IT_CVAR | IT_CV_FLOATSLIDER, NULL, "Camera Spacial Speed", &cv_cam2_speed, 51},
	{IT_STRING  | IT_CVAR | IT_CV_FLOATSLIDER, NULL, "Rotation Speed", &cv_cam2_turnmultiplier, 56},

	{IT_HEADER,            NULL, "Display Options", NULL, 65},
	{IT_STRING  | IT_CVAR, NULL, "Crosshair", &cv_crosshair2, 71},
};
