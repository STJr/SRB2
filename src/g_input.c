...
static keyname_t keynames[] =
{
	...
	{KEY_MOUSE1+6,"mouse7"},
	{KEY_MOUSE1+7,"mouse8"},
	{KEY_2MOUSE1+0,"sec_rmb"}, // BP: sorry my mouse handler swap button 1 and 2
	{KEY_2MOUSE1+1,"sec_lmb"},
	{KEY_2MOUSE1+2,"sec_mmb"},
	...
	{KEY_2JOY1+0, "sec_a button"},
	{KEY_2JOY1+1, "sec_b button"},
	{KEY_2JOY1+2, "sec_x button"},
	{KEY_2JOY1+3, "sec_y button"},
	{KEY_2JOY1+4, "sec_lb"},
	{KEY_2JOY1+5, "sec_rb"},
	{KEY_2JOY1+6, "sec_back"},
...
#endif
	// the DOS version uses Allegro's joystick support
	{KEY_2HAT1+0,  "sec_dpadup"},
	{KEY_2HAT1+1,  "sec_dpaddown"},
	{KEY_2HAT1+2,  "sec_dpadleft"},
	{KEY_2HAT1+3,  "sec_dpadright"},
