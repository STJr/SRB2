...
void V_BlitScaledPic(INT32 rx1, INT32 ry1, INT32 scrn, pic_t * pic)
{
	INT32 dupx, dupy;
	INT32 x, y;
	UINT8 *src, *dest;
...
// Very similar to V_DrawFadeConsBack, except we draw from the middle(-ish) of the screen to the bottom.
