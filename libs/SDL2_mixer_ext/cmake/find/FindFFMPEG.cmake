...
MixerX: Other than avcodec, avformat, avutil, swresample, disabled as unnecessary
...
function (_ffmpeg_find component headername)
  ...
  if(APPLE)
    set(DYNAMIC_LIBRARY_SUFFIX ".dylib")
  elseif(WIN32)
  ...
  find_library("FFMPEG_${component}_DYNAMIC_LIBRARY"
    NAMES
      "${component}"
    PATHS
      "${FFMPEG_ROOT}/lib"
      ...
      /usr/freeware/bin
      "${FFMPEG_ROOT}/bin"
    PATH_SUFFIXES ${DYNAMIC_LIBRARY_SUFFIX}
    DOC "FFMPEG's ${component} dynamic library")
  mark_as_advanced("FFMPEG_${component}_DYNAMIC_LIBRARY")
  ...
  if (FFMPEG_${component}_LIBRARY AND FFMPEG_${component}_INCLUDE_DIR)
    ...
    if (_deps_found)
      ...
      set(FFMPEG_${component}_LIBRARIES ${FFMPEG_${component}_LIBRARIES} PARENT_SCOPE)
      list(APPEND FFMPEG_FIND_COMPONENTS "${component}")
...
# MixerX: Unnecessary components were disabled
